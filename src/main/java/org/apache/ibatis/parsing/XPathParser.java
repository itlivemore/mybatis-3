...
public class XPathParser {
	 ...
	 * <p>
	 * The default value is {@code false} (indicate disable using a xsd file xml
	 * parsing) If you specify the {@code true}, you can use a xsd file on config
	 * xml or mapper xml.
	 * </p>
	 * 
	 * @since 3.5.0
